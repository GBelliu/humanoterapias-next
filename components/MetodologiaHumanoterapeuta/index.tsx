...
export function MetodologiaHumanoterapeuta() {
  return (
    <Container>
      ...
      <Content>
        <TextContent>
          <h2>Mesa Quantiônica</h2>
          <p>
            A Mesa Quantiônica representa o ponto de partida em direção à
        ...
        <TextContent>
          <h2>Humanometria</h2>
          <p>
            A Humanometria, trata a energia presa no campo eletromagnético. Sabe
          ...
          <p>
            A Humanometria trata também, auto obsessão, obsessão de encarnado ou
        ...
        <TextContent>
          <h2>Taquions Tock</h2>
          <p>
            A Técnica de Taquions Tock trabalha com a frequência de quinta
          ...
          <p>
            A energia taquiônica sintoniza com quem somos em Essência para
        ...
        <ImageContent>
          <div>
            <img src="./taquions.jpeg" alt="" />
          </div>
        </ImageContent>
        <ImageContent>
          <div>
            <img src="./tdr.jpeg" alt="" />
          </div>
        </ImageContent>
        <TextContent>
          <h2>TDR</h2>
          <p>
            O tratamento com a TDR é uma experiência de muita intensidade
        ...
        <TextContent>
          <h2>Regressão com Reprogramação</h2>
          <p>
            A finalidade desta técnica é rastrear os registros de memórias
        ...
        <ImageContent>
          <div>
            <img src="./regressao.jpeg" alt="" />
          </div>
        </ImageContent>
        <ImageContent>
          <div>
            <img src="./cigano.jpeg" alt="" />
          </div>
        </ImageContent>
        <TextContent>
          <h2>Baralho Terapêutico</h2>
          <p>
            A finalidade do Baralho é uma leitura terapêutica, e não oracular ou
